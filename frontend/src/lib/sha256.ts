// Incremental SHA-256 (RFC 6234), because Web Crypto's crypto.subtle.digest is one-shot
// only and whole-file hashes here run over files up to ~5GB fed in 8MiB slices.
